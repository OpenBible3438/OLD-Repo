			...
			<div class="modal-content">
				...
				<div class="modal-body" style="padding-left: 40px; padding-right: 40px; padding-top: 20px">
					...
					<form role="form" id="f_upd">
						...
						<div class="form-group row">
							<label for="upd_cls_s_date" class="col-sm-3 col-form-label"><b>판매시작</b></label> 
							<div class="col-sm-9">
								<input type="date" class="form-control input-sm" id="upd_cls_s_date" name="upd_cls_s_date" placeholder="연도-월-일">
							</div>
						</div>
						<div class="form-group row">
							<label for="upd_cls_e_date" class="col-sm-3 col-form-label"><b>판매종료</b></label> 
							<div class="col-sm-9">
						...
						<div class="form-group row">
							<label for="upd_cls_days" class="col-sm-3 col-form-label"><b>수업 일수</b></label> 
							<div class="col-sm-9">
								<input type="text" class="form-control input-sm" id="upd_cls_days" name="upd_cls_days">
							</div>
						</div>					
						<div class="form-group row">
