...
<div class="btn-group" id="button_group" style="width:100%">
	<button type="button" class="b1 btn-primary m-1" data-toggle="modal" data-target="" onclick="tchList()">전체조회</button>
	...
	<button type="button" class="b1 btn-primary m-1" data-toggle="modal" data-target="#info" onclick="tchClassList()">맡은 수업 보기</button>
</div>
<br>
<!-- 테이블 부분 -->
<table class="table table-bordered" data-toggle="table"
	...
	<thead>
		<tr align="center">
			...
			<th data-field="TCH_PROFIMG">사진</th>
