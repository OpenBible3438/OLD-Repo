	...
	<div class="container">
		<form role="form" id="f_ins">
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm" id="c_name" name="c_name"
			...
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm" id="c_tName" name="c_tName"
					   placeholder="강사 번호를 선택하세요." readonly>
			</div>
			<div class="form-group">
				<label for="c_sports"><b>종목</b></label> 
				<input type="text" class="form-control input-sm" id="c_sports" name="c_sports"
			...
			<div class="form-group">
				...
				<input type="date" class="form-control input-sm" id="c_startDate" name="c_startDate"
					   placeholder="시작일">
			</div>
			<div class="form-group">
				<label for="c_endDate"><b>종료일</b></label> 
				<input type="date" class="form-control input-sm" id="c_endDate" name="c_endDate"
					   placeholder="종료일">
			</div>
			<div class="form-group">
				<label for="c_totalDays"><b>수업 일수</b></label> 
				<input type="text" class="form-control input-sm" id="c_totalDays" name="c_totalDays"
					   placeholder="시작일과 종료일을 입력하세요.">
			</div>
			<div class="form-group">
				<label for="c_times"><b>수업 횟수</b></label> 
				<input type="text" class="form-control input-sm" id=c_times " name="c_times"
			...
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm" id="c_price" name="c_price"
					   placeholder="숫자만 입력하세요.">
			</div>
			<div class="form-group">
				<label for="c_groupCode"><b>그룹코드</b></label> 
				<input type="text" class="form-control input-sm" id="c_groupCode" name="c_groupCode"
