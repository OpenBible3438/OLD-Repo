...
public class GymDao {
	...
	///////////////////////////////////////////////////////////////////////////
	//매장 로그인
	public List<Map<String, Object>> getLogin(Map<String, Object> pMap) throws SQLException {//로그인
	...
	public int getIdConfirm(Map<String, Object> pMap) throws SQLException {
		...
		if(idResult == 0 ) {
			idResult = sqlSession.selectOne("getIdConfirm2",pMap);
		}
		return idResult;
	}
	...
	public List<Map<String, Object>> get_newmem(Map<String, Object> pMap) throws SQLException {//월별 수강생 증가
	...
	public List<Map<String, Object>> get_tchChart(Map<String, Object> pMap) throws SQLException {//강사별 월별 매출
	...
	public List<Map<String, Object>> get_gym_sale(Map<String, Object> pMap) throws SQLException {//매장 월별 매출
	...
	// 콘텐츠 이미지 등록 
	public int contentImgIns(Map<String, Object> pMap) throws SQLException {
		logger.info("GymDao - chartIns() 호출");
	...
	// 매장 콘텐츠 이미지 수정 
	public int contentImgUpd(Map<String, Object> pMap) throws SQLException {
	...
	// 매장 콘텐츠 이미지 삭제 
	public int contentImgDel(Map<String, Object> pMap) throws SQLException {
	...
	// 매장 정보 이미지 수정 
	public int gymInfoImgUpd(Map<String, Object> pMap) throws SQLException {
	...
	// 매장 회원가입 
	public int gymJoin(Map<String, Object> pMap) throws SQLException {
		logger.info("GymDao - gymJoin() 호출");
		int gym_no = sqlSession.selectOne("getGymNo",pMap);
	...
	//매장 이미지 입력
	public int gymJoinImg(Map<String, Object> pMap) throws SQLException {
	...
	// 매장 회원가입 시 디폴트 강사 등록 
	public int gymJoinTch(Map<String, Object> pMap) throws SQLException, IOException {
		logger.info("GymDao - gymJoinTch() 호출");
		result = sqlSession.insert("gymJoinTch", pMap);
		if(result == 1) {
			FileInputStream fis = new FileInputStream(((File)pMap.get("file")));
			pMap.put("filedata",fis);
			result = sqlSession.insert("gymJoinTchImg", pMap);
			if(result == 1) {
				result = sqlSession.insert("gymJoinTchProf", pMap);
			}
		}
		logger.info("result : " + result);
		return result;
